...
{{-- contoh --}}
    ...
    <div class="container">
      <a class="navbar-brand" href="{{ route('beranda.index') }}">Lelang</a>
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
      <form class="d-flex" role="search" action="{{ route('beranda.index') }}">
      ...
      <div class="row ms-auto">
        <div class="col-md ms-auto">
              <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link" href="{{ route('informasi') }}">Informasi Lelang</a>
                </li>
                <li class="nav-item"><a href="{{ route('login') }}"><button type="submit" class="btn btn-warning btn-md">Login</button></a>
                </li>
              </ul>
            </div>
            </div>
